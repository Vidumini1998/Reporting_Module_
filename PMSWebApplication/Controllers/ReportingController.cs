...
namespace PMSWebApplication.Controllers
{
    public class ReportingController : Controller
    {
        ...
        public async Task<ActionResult> ExportDueAmountReport1()
        {
        ...
        //public ActionResult ProjectStatusReport(string status)
        //{
        //    if (status != null)
        //    {
        //        try
        //        {
        //            var searchlist = db.Tasks(Projet);

        //            var model = new Project()
        //            {
        //                ProjectName = new List<ProjectStatusReport>()
        //            };
